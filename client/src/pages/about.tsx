          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="grid md:grid-cols-2 gap-16 max-w-5xl mx-auto">
              <motion.div
                ...
                animate={{ opacity: 1, x: 0 }}
              >
                <Badge className="bg-primary/10 text-primary border-none mb-4">Our Mission</Badge>
              ...
              <motion.div
                ...
                animate={{ opacity: 1, x: 0 }}
              >
                <Badge className="bg-primary/10 text-primary border-none mb-4">Our Values</Badge>
